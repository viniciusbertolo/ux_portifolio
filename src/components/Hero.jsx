  ...
  return (
    ...
    <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-6rem)]">
      ...
      >
        ...
        <motion.div variants={itemVariants} className='relative w-[95%] sm:w-48 h-10 bg-gradient-to-r from-[#ff8c00] to-[#ff0080] shadow-[0_0_15px_rgba(255,255,255,0.4)] rounded-full'>
        ...
        <motion.div variants={itemVariants} className='flex gap-4 mt-12'>
          ...
          <a className='font-[Open_Sans] border border-[#2a2a2a] py-2 sm:py-3 px-8 sm:px-10 rounded-full sm:text-lg text-sm font-semibold tracking-wider transition-all duration-300 hover:bg-[#1a1a1a] bg-gray-300 text-black hover:text-white' href="#">
